...
def test_lapsen_rasvaprosentti_tytto():
    assert round(laskenta.lapsen_rasvaprosentti(25, 16, 0), 1) == 27.9 # huom. pyöristys    

# Pojan rasvaprosentti, kun bmi on 25 ja ika 16
def test_lapsen_rasvaprosentti_poika():
    assert round(laskenta.lapsen_rasvaprosentti(25, 16, 1), 1) == 24.3 # huom. pyöristys